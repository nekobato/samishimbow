...
// in simulator we redefine to format for Samishimbow Developer console
...
{\
	NSString * exceptionName = [@"org.samishimbow." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.samishimbow";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UISamishimbowNativeItemNone = -1, 
	UISamishimbowNativeItemSpinner = -2,
	UISamishimbowNativeItemProgressBar = -3,
	
	UISamishimbowNativeItemSlider = -4,
	UISamishimbowNativeItemSwitch = -5,
	UISamishimbowNativeItemMultiButton = -6,
	UISamishimbowNativeItemSegmented = -7,
	
	UISamishimbowNativeItemTextView = -8,
	UISamishimbowNativeItemTextField = -9,
	UISamishimbowNativeItemSearchBar = -10,
	
	UISamishimbowNativeItemPicker = -11,
	UISamishimbowNativeItemDatePicker = -12,
	
	UISamishimbowNativeItemInfoLight = -13,
	UISamishimbowNativeItemInfoDark = -14,
	
	UISamishimbowNativeItemDisclosure = -15,
	
	UISamishimbowNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Samishimbow instances of
