...
@interface SamishimbowObject : KrollCoverageObject {
#else
@interface SamishimbowObject : KrollObject {
#endif
@private
...
extern NSString * Samishimbow$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	SamishimbowObject *_samishimbow;
    KrollObject* console;
	BOOL shutdown;
