...
/**
 Base class for all Samishimbow views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Samishimbow view hierarchy (such as wrapped iOS UIViews) was touched.
