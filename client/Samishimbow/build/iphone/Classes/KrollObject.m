 ...
 * Copyright (c) 2009-2011 by Samishimbow, Inc. All Rights Reserved.
...
//@interface SamishimbowObject : NSObject
//@end

@interface SamishimbowObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[SamishimbowObject class]])
		{
			for (NSString *key in [[(SamishimbowObject*)o modules] allKeys])
			{
